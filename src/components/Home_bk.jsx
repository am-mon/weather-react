...
const Home = () => {
  ...
  return (
    <div className="bg-zinc-200 min-h-[100vh]">
      <Section>
        <h1 className="text-2xl md:text-4xl text-center mb-10 font-medium">
        ...
        <div className="my-10 max-w-[800px] mx-auto">
          ...
          >
            ...
            <button
              ...
              className="flex items-center justify-center bg-zinc-600 hover:bg-zinc-500 text-white font-light rounded h-[45px] px-3 cursor-pointer "
            >
          ...
          <div className="mt-10">
            ...
            <div>
                  ...
                  ?.map((item, index) => {
                    return (
                      <div
                        key={index}
                        id={`item_${index}`}
                        className="text-base bg-white rounded px-5 py-5 md:p-5 mt-5 flex"
                      >
                        <div className="w-full md:w-[50%]">
                        ...
                        <div className="w-full md:w-[50%]">
                          ...
                          <button
                            ...
                            className="text-sm mt-3 p-2 bg-black rounded text-white float-right"
                          >
                            Delete
                          </button>
                        </div>
              ...
              {!historyList && <p className="mt-5">No search history yet.</p>}
            </div>
          </div>
        </div>
      </Section>
